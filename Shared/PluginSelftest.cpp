...
bool CPluginSelftest::Send()
{
    ...
    if (lock.IsLocked())
    {
        ...
        bResult = CPluginClient::SendFtpFile(_T("ftp.ieadblocker.com"), CPluginSettings::GetDataPath("selftest.txt"), outputFile);
    }
...
bool CPluginSelftest::Send()
{
    ...
    if (bResult)
    {
        ...
        bResult = CPluginClient::SendFtpFile(_T("ftp.ieadblocker.com"), tempFile, outputFile);
    }
