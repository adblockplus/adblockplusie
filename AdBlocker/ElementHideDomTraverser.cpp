...
#include "ElementHideDomTraverser.h"
...
CElementHideDomTraverser::CElementHideDomTraverser() : CPluginDomTraverser<CElementHideDomTraverserCache>()
{
}


void CElementHideDomTraverser::TraverseSubdocument(IWebBrowser2* pBrowser, const CString& domain, const CString& documentName)
{
	CPluginDomTraverser<CElementHideDomTraverserCache>::TraverseDocument(pBrowser, false, "");
}

bool CElementHideDomTraverser::OnIFrame(IHTMLElement* pEl, const CString& url, CString& indent)
{
...
bool CElementHideDomTraverser::OnElement(IHTMLElement* pEl, const CString& tag, CElementHideDomTraverserCache* cache, bool isDebug, CString& indent)
{
	if (cache->m_isHidden)
	{
		return false;
...
bool CElementHideDomTraverser::IsEnabled()
{ 
	CPluginClient* client = CPluginClientFactory::GetLazyClientInstance();
...
void CElementHideDomTraverser::HideElement(IHTMLElement* pEl, const CString& type, const CString& url, bool isDebug, CString& indent)
{
